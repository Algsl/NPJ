...
public class Settings {
    ...
    public boolean getEnableBackgroundPlay() {
        ...
        return SharePerferenceUtils.getBoolean(mAppContext,key, false);
    }

    public int getPlayer() {
        String key = mAppContext.getString(R.string.pref_key_player);
        String value = SharePerferenceUtils.getString(mAppContext,key, "");
        try {
    ...
    public String getPixelFormat() {
        ...
        return SharePerferenceUtils.getString(mAppContext,key, "");
    }
