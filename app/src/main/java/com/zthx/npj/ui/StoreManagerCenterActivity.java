    ...
    private void getOfflineLog() {
        ...
        SetSubscribe.offlineLog(bean, new OnSuccessAndFaultSub(new OnSuccessAndFaultListener() {
            ...
            public void onSuccess(String result) {
                ...
                acIncomeLogTvIoMoney.setText("我的收益额："+bean.getData().getShouyi()+"元");
                RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(StoreManagerCenterActivity.this);
                acIncomeLogRvMingxi.setLayoutManager(layoutManager);
                OfflineLogAdapter adapter = new OfflineLogAdapter(StoreManagerCenterActivity.this, data);
