...
public class MyCollectStoreAdapter extends RecyclerView.Adapter<MyCollectStoreAdapter.ViewHolder> {
    ...
    public MyCollectStoreAdapter(Context context, List<CommentGoodsBeen> list) {
        mList = list;
        mContext = context;
    }
    @NonNull
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        return new MyCollectStoreAdapter.ViewHolder(view);
    }
