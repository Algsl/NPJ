...
/**
 * Created by huangxin on 2019/5/20.
 */

public class SupplyManagerListAdapter extends RecyclerView.Adapter<SupplyManagerListAdapter.ViewHolder>{
    ...
    public SupplyManagerListAdapter(Context context, List<CommentGoodsBeen> list) {
        this.list = list;
        mContext = context;
    }
    @NonNull
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_supply_manager_list, viewGroup, false);
        return new SupplyManagerListAdapter.ViewHolder(view);
    }
