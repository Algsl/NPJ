...
public class SupplyLogAdapter extends RecyclerView.Adapter<SupplyLogAdapter.ViewHolder> {

    private ArrayList<SupplyLogResponseBean.DataBean.Mingxi> mList;
    private Context mContext;

    public SupplyLogAdapter(Context context, ArrayList<SupplyLogResponseBean.DataBean.Mingxi> list){
        mList=list;
        mContext=context;
    }
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        return new SupplyLogAdapter.ViewHolder(view);
    }
