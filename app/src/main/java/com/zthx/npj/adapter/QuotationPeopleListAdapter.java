...
public class QuotationPeopleListAdapter extends RecyclerView.Adapter<QuotationPeopleListAdapter.ViewHolder>{
    ...
    public QuotationPeopleListAdapter(Context context, List<CommentGoodsBeen> list) {
        this.list = list;
        mContext = context;
    }
    @NonNull
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        return new QuotationPeopleListAdapter.ViewHolder(view);
    }
