...
public class CommenRewardAdapter extends RecyclerView.Adapter<CommenRewardAdapter.ViewHolder>{
    ...
    public CommenRewardAdapter(Context context, List<CommentGoodsBeen> list) {
        this.list = list;
        mContext = context;
    }
    @NonNull
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_commen_rewards, viewGroup, false);
        return new CommenRewardAdapter.ViewHolder(view);
    }
