...
public class ShoppingCartAdapter extends BaseExpandableListAdapter {
    ...
    public ShoppingCartAdapter(List<StoreInfo> groups, Map<String, List<GoodsInfo>> childrens, Context mcontext) {
        this.groups = groups;
    ...
    public View getGroupView(final int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        groupViewHolder.storeJuan.setOnClickListener(new GroupViewClick(group, groupPosition, groupViewHolder.storeJuan));
        return convertView;
    }
...
//        dialog.show();
    ...
    static class GroupViewHolder {
        @BindView(R.id.item_shopping_cart_cb_store)
        CheckBox storeCheckBox;
        @BindView(R.id.item_shopping_cart_tv_store_name)
        TextView storeName;
        @BindView(R.id.item_shopping_cart_tv_juan)
        TextView storeJuan;
...
//                }
    ...
    static class ChildViewHolder {
        ...
        @BindView(R.id.item_shopping_cart_product_title)
        TextView goodsName;
        @BindView(R.id.item_shopping_cart_tv_goods_size)
        TextView goods_size;
        @BindView(R.id.goods_price)
        TextView goodsPrice;
        @BindView(R.id.goods_data)
        RelativeLayout goodsData;
        @BindView(R.id.item_shopping_rl_cart_num_add)
        RelativeLayout increaseGoodsNum;
        @BindView(R.id.item_shopping_tv_cart_num)
        TextView goodsSize;
        @BindView(R.id.item_shopping_rl_cart_num_jian)
        RelativeLayout delGoods;
