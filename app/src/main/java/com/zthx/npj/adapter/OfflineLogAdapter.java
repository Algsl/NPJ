...
public class OfflineLogAdapter extends RecyclerView.Adapter<OfflineLogAdapter.ViewHolder> {

    private ArrayList<OfflineLogResponseBean.DataBean.Mingxi> mList;
    private Context mContext;

    public OfflineLogAdapter(Context context, ArrayList<OfflineLogResponseBean.DataBean.Mingxi> list){
        mList=list;
        mContext=context;
    }
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        return new OfflineLogAdapter.ViewHolder(view);
    }
