...
public class StoreCouponAdapter extends RecyclerView.Adapter<StoreCouponAdapter.ViewHolder>{
    ...
    public StoreCouponAdapter(Context context, List<CommentGoodsBeen> list) {
        this.list = list;
        mContext = context;
    }
    @NonNull
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_store_coupon, viewGroup, false);
        return new StoreCouponAdapter.ViewHolder(view);
    }
