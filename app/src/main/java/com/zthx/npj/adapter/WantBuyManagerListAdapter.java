...
public class WantBuyManagerListAdapter extends RecyclerView.Adapter<WantBuyManagerListAdapter.ViewHolder>{
    ...
    public WantBuyManagerListAdapter(Context context, List<CommentGoodsBeen> list) {
        this.list = list;
        mContext = context;
    }
    @NonNull
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        return new WantBuyManagerListAdapter.ViewHolder(view);
    }
