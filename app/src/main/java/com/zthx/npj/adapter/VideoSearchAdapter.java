...
public class VideoSearchAdapter extends RecyclerView.Adapter<VideoSearchAdapter.ViewHolder>{
    ...
    public VideoSearchAdapter(Context context,List<CommentGoodsBeen> list) {
        mContext = context;
        mList = list;
    }
    @NonNull
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_search_video,viewGroup,false);
        return new VideoSearchAdapter.ViewHolder(view);
    }
