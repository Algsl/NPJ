...
public class MyCollectGoodsAdapter extends RecyclerView.Adapter<MyCollectGoodsAdapter.ViewHolder> {
    ...
    public MyCollectGoodsAdapter(Context context, List<CommentGoodsBeen> list) {
        mList = list;
        mContext = context;
    }
    @NonNull
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        return new MyCollectGoodsAdapter.ViewHolder(view);
    }
